...
- Click inside the Branch-by-Sales pivot table, Insert tab, PivotChart, choose a horizontal bar chart, sorted largest to smallest, confirming Trans-Amadi leads
- Add a second chart, this time from the Branch-by-Product-line data: a bar chart of total Sales by Product line, and point out Food and beverages leads at ₦5,614,484.40, closely followed by Sports and travel at ₦5,512,282.65, close enough that a bar chart is the right call, not a pie chart
...
> "Watch what happens when I click Trans-Amadi." [click the slicer] "Both charts just responded together. That's the difference between a page of charts and an actual report."
...
- Repeat with a second related question, given cold, that trainees have not seen prepared for: "which product line should Trans-Amadi stock more of?"
